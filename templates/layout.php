...
<div class="page-wrapper">
    ...
    <header class="main-header">
        <div class="main-header__container container">
            ...
            <a class="main-header__add-lot button" href="adds.php">Добавить лот</a>
    ...
    <footer class="main-footer">
        ...
        <div class="main-footer__bottom container">
            ...
            <a class="main-footer__add-lot button" href="adds.php">Добавить лот</a>
    ...
    <?php /* <script src="script.js"></script> */?>
</body>
</html>
